...
{
  Product* clothing=new Clothing(size_, brand_, categoryID(), prodName_, price_, qty_);
  return clothing;
...
{
  //Product* movie=new Movie(genre_, rating_):Product(categoryID(), prodName_,price_, qty_);
