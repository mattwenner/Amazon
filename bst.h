...
template <class KeyType, class ValueType>
 ...
 public:
  ...
  //calls private helper function for chicking if current node is a left child
  bool isLeftChild(){
    if(this->getParent()==NULL){
      return false;
    }
    return this->isLeftChildHelper();
  }
  //calls private helper function for checking if current node is a right child
  bool isRightChild(){
    if(this->getParent()==NULL){
      return false;
    }
    return this->isRightChildHelper();
  }
 ...
 public:
  ...
  public:
    ...
    iterator& operator++(){
    	...
    	//If right child exists, successor is the left most
		...
		traverse the first left child pointer (find the first
		node who is a left child of his parent…that
